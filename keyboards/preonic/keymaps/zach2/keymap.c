 ...
 * |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
 * | Brite |  FN   |  Alt  |  GUI  | Lower | Enter | Space | Raise | Left  | Down  |  Up   | Right |
 * `-----------------------------------------------------------------------------------------------'
 */
[_QWERTY] = {
  ...
  {BACKLIT, ADJUST,  KC_LALT, KC_LGUI, LOWER,   KC_ENT,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT}
},
...
[_LOWER] = {
  ...
  {_______, KC_BTN1, KC_MS_U, KC_BTN2, KC_WH_U, _______, KC_UNDS, KC_LBRC, KC_RBRC, _______, _______, _______},
 ...
 * |       |       |       |   {   |   }   |       |   =   |   1   |   2   |   3   |       |       |
 * |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
 * |       |       | RAlt  | RGUI  |       |       |       |       | Mute  | Vol - | Vol + |       |
 * `-----------------------------------------------------------------------------------------------'
 */
[_RAISE] = {
  {KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    _______},
  {KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    _______},
  {KC_RCTL, _______, _______, KC_LPRN, KC_RPRN, _______, KC_MINS, KC_4,    KC_5,    KC_6,    _______, _______},
  {_______, _______, _______, KC_LCBR, KC_RCBR, _______, KC_EQL,  KC_1,    KC_2,    KC_3,    _______, _______},
  {_______, _______, KC_RALT, KC_RGUI, _______, _______, _______, _______, KC_MUTE, KC_VOLD, KC_VOLU, _______}
},
 ...
 * |-------+-------+-------+-------+-------+-------|-------+-------+-------+-------+-------+-------|
 * | Caps  | " Off | AgNrm | " Off | " Off | " Off | Voic- |       | Prev  | Stop  | Pause | Next  |
 * |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
...
[_ADJUST] = {
  ...
  {KC_CAPS, AU_OFF,  AG_NORM, ZC_NGUI, MI_OFF,  MU_OFF,  MUV_DE,  _______, KC_MPRV, KC_STOP, KC_PAUS, KC_MNXT},
