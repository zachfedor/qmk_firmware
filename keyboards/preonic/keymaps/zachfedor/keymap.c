...
[_GAMING] = LAYOUT_preonic_grid( \
  ...
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,  \
  KC_GRV,  _______, _______, KC_SPC,  LOWER,   _______, _______, RAISE,   _______, _______, _______, _______  \
),
...
[_RAISE] = LAYOUT_preonic_grid( \
  ...
  _______, KC_LT,   KC_GT,   KC_LCBR, KC_RCBR, _______, KC_EQL,  KC_1,    KC_2,    KC_3,    _______, _______, \
 ...
 * |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
 * |       | Qwrty | Colmk | Dvrak | Gamng |       |       |       |       |  F11  |  F12  |       |
 * |-------+-------+-------+-------+-------+---------------+-------+-------+-------+-------+-------|
 * |       |       | AgSwp | GUI   | Audio | Music | Voic+ |       |       |       |       |       |
 * |-------+-------+-------+-------+-------+-------|-------+-------+-------+-------+-------+-------|
 * | Caps  |       | AgNrm | " Off | " Off | " Off | Voic- |       | Prev  | Stop  | Pause | Next  |
 * |-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------+-------|
...
[_ADJUST] = LAYOUT_preonic_grid( \
  ...
  _______, QWERTY,  COLEMAK, DVORAK,  GAMING,  _______, _______, _______, _______, KC_F11,  KC_F12,  _______, \
  _______, _______, AG_SWAP, ZC_GUI,  AU_ON,   MU_ON,   MUV_IN,  _______, _______, _______, _______, _______, \
  KC_CAPS, _______, AG_NORM, ZC_NGUI, AU_OFF,  MU_OFF,  MUV_DE,  _______, KC_MPRV, KC_STOP, KC_PAUS, KC_MNXT, \
