...
[_RAISE] = {
  ...
  {_______, KC_LT,   KC_GT,   KC_LCBR, KC_RCBR, _______, KC_EQL,  KC_1,    KC_2,    KC_3,    _______, ______},
  {_______, _______, KC_RALT, KC_RGUI, _______, _______, _______, _______, KC_MUTE, KC_VOLD, KC_VOLU, ________}
},
